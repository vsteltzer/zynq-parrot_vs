...
set vivado_vers "[version -short]"
puts "The version of Vivado Design Suite is ${vivado_vers}"
if {[string first "2018.3" $vivado_vers] != -1} {
  puts "1"
  set ps_ver 3.2
} elseif {[string first "2019.1" $vivado_vers] != -1} {
  set ps_ver 3.3
  puts "2"
} elseif {[string first "2019.2" $vivado_vers] != -1} {
  set ps_ver 3.3
  puts "3"
} elseif {[string first "2021.2" $vivado_vers] != -1} {
  set ps_ver 3.3
  puts "4"
} elseif {[string first "2022.1" $vivado_vers] != -1} {
  set ps_ver 3.4
  puts "5"
}
...
startgroup
  # Create instance: zynq_ultra_ps_e_0, and set properties
   set zynq_ultra_ps_e_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:zynq_ultra_ps_e:${ps_ver} zynq_ultra_ps_e_0 ]
...
assign_bd_address -offset 0x1000000000 -range 4K -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs top_0/s00_axi/reg0]
  assign_bd_address -offset 0x5000000000 -range 1G -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs top_0/s01_axi/reg0]
#set_property offset 0x1000000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs top_0/s01_axi/reg0]
#set_property offset 0x5000000000 [get_bd_addr_segs {zynq_ultra_ps_e_0/Data/SEG_top_0_reg0}]
#set_property range 4K [get_bd_addr_segs {zynq_ultra_ps_e_0/Data/SEG_top_0_reg0}]
#set_property range 1G [get_bd_addr_segs {zynq_ultra_ps_e_0/Data/SEG_top_0_reg0}]
